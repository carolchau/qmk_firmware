...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_BASE] = LAYOUT_all(
        KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,   KC_EQL,  KC_BSPC, XXXXXXX,     MO(_WASD), KC_PSLS, KC_PAST, KC_PMNS,
    ...
    [_FUNC] = LAYOUT_all(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RESET,   XXXXXXX,     KC_NLCK, _______, _______, _______,
        ...
        _______, XXXXXXX, _______, _______, _______, _______, _______, _______, KC_MUTE, _______, _______, _______, _______, _______,              _______, _______, _______, XXXXXXX,
